...
def crear_tablas():
    ...
    try:
        ...
        # CORREGIDO: Insertar todas las soluciones visuales con sintaxis Python válida
        ...
        if cursor.fetchone()[0] == 0:
            soluciones_ejemplo = [
                ...
                },
                {
                    ...
                    'categoria': 'Softv',
                    'descripcion': 'Guía para consultar el historial de pagos y facturas de los clientes',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'softv/softv_facturas.png'
                },
                {
                    'titulo': '¿Como consultamos las ordenes de servicio de los usuarios?',
                    'categoria': 'Softv',
                    'descripcion': 'Procedimiento para revisar órdenes de servicio asociadas a un cliente',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'softv/softv_ordenes.png'
                },
                {
                    'titulo': '¿Como consultamos reportes de fallas de los usuarios?',
                    'categoria': 'Softv',
                    'descripcion': 'Guía para consultar reportes de fallas registrados por los clientes',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'softv/softv_reportes.png'
                },
                {
                    'titulo': '¿Como creamos un reporte de falla?',
                    'categoria': 'Softv',
                    'descripcion': 'Procedimiento completo para crear un nuevo reporte de falla',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'softv/softv_crear_reporte.png'
                },
                {
                    'titulo': '¿Como creamos una orden de servicio?',
                    'categoria': 'Softv',
                    'descripcion': 'Procedimiento para crear órdenes de servicio en el sistema',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'softv/softv_crear_orden.png'
                },
                {
                    'titulo': '¿Como borramos un reporte de falla en caso necesario?',
                    'categoria': 'Softv',
                    'descripcion': 'Procedimiento para eliminar reportes de falla del sistema',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'softv/softv_eliminar_reporte.png'
                },
                {
                    'titulo': '¿Como ingresamos un nuevo cliente?',
                    'categoria': 'Softv',
                    'descripcion': 'Guía completa para registrar nuevos clientes en el sistema',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'softv/softv_nuevo_cliente.png'
                },
                {
                    'titulo': '¿Como buscar un usuario?',
                    'categoria': 'Vortex',
                    'descripcion': 'Procedimiento para buscar usuarios en el sistema Vortex',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'vortex/vortex_buscar.png'
                },
                {
                    'titulo': '¿Como validar puertos en uso y la MAC del equipo?',
                    'categoria': 'Vortex',
                    'descripcion': 'Validación de configuración de puertos y dirección MAC',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'vortex/vortex_puertos.png'
                },
                {
                    'titulo': '¿Como validar si el usuario esta teniendo consumo del servicio?',
                    'categoria': 'Vortex',
                    'descripcion': 'Verificación del consumo de servicio en tiempo real',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'vortex/vortex_consumo.png'
                },
                {
                    'titulo': '¿Como cambiar la VLAN?',
                    'categoria': 'Vortex',
                    'descripcion': 'Procedimiento para modificar la configuración de VLAN',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'vortex/vortex_vlan.png'
                },
                {
                    'titulo': '¿Como realizar un resync config?',
                    'categoria': 'Vortex',
                    'descripcion': 'Procedimiento para resincronizar la configuración del dispositivo',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'vortex/vortex_resync.png'
                },
                {
                    'titulo': '¿Como realizar un reboot?',
                    'categoria': 'Vortex',
                    'descripcion': 'Procedimiento para reiniciar el dispositivo',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'vortex/vortex_reboot.png'
                },
                {
                    'titulo': '¿Como identificar si el servicio de internet y TV estan activados?',
                    'categoria': 'Vortex',
                    'descripcion': 'Verificación del estado de servicios Internet y TV',
                    'pasos': json.dumps([
                        {
                    ...
                    'imagen': 'vortex/vortex_servicios.png'
                }
            ]
            ...
            print(f"✅ {len(soluciones_ejemplo)} soluciones visuales de ejemplo creadas")
