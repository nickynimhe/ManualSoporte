...
def politicas_seguridad():
    politicas = {
        'titulo': 'POLÍTICAS Y SANCIONES POR VULNERACIÓN DE LA SEGURIDAD DEL CRM SOFTV',
        'contenido': [
            {
                'subtitulo': '1. Introducción',
                'contenido_items': [
                    'El presente documento establece las políticas, lineamientos y sanciones aplicables a todos los colaboradores, contratistas y personal autorizado que acceden al sistema CRM SOFTV de la empresa M@STV PRODUCCIONES S.A.S NIT 900.943.073-9, con el fin de garantizar la integridad, confidencialidad y disponibilidad de la información corporativa y de los clientes.'
                ]
            },
            {
                'subtitulo': '2. Alcance',
                'contenido_items': [
                    'Estas políticas aplican a todo el personal con acceso al CRM SOFTV, incluyendo personal técnico, administrativo, comercial y de soporte, sin excepción.'
                ]
            },
            {
                'subtitulo': '3. Objetivo',
                'contenido_items': [
                    'Prevenir y mitigar incidentes de seguridad derivados del uso inadecuado del CRM SOFTV, protegiendo los datos personales, operativos y comerciales de la compañía.'
                ]
            },
            {
                'subtitulo': '4. Políticas de Seguridad',
                'contenido_items': [
                    'Usar credenciales personales e intransferibles.',
                    'Mantener la confidencialidad de la información de clientes, proveedores y procesos internos.',
                    'No compartir contraseñas, tokens o accesos con terceros.',
                    'No exportar, copiar o descargar información sin autorización expresa del área de TI o Seguridad Informática.',
                    'No realizar modificaciones, eliminaciones o alteraciones de datos sin respaldo o justificación.',
                    'No instalar software externo o herramientas no autorizadas para acceder al CRM.',
                    'Reportar de inmediato cualquier anomalía, acceso sospechoso o incidente de seguridad.',
                    'Cumplir con las normas de uso ético y responsable de los sistemas corporativos.'
                ]
            },
            {
                'subtitulo': '5. Violaciones Típicas',
                'contenido_items': [
                    'Compartir credenciales con otro colaborador.',
                    'Descargar bases de datos o reportes sin autorización.',
                    'Ingresar al sistema con cuentas de terceros.',
                    'Modificar o eliminar información de clientes sin justificación.',
                    'Divulgar información confidencial a personas ajenas a la empresa.',
                    'Usar el CRM con fines personales o para beneficio de terceros.',
                    'Intentar acceder a secciones o módulos no asignados a su rol.',
                    'No reportar incidentes de seguridad detectados.'
                ]
            },
            {
                'subtitulo': '6. Sanciones',
                'contenido_items': [
                    'Cualquier violación a las políticas de seguridad del CRM SOFTV será considerada falta grave y podrá conllevar:',
                    'Por primera vez, suspensión laboral de cuatro (4) a ocho (8) días. (proceso disciplinario abreviado)',
                    'Por segunda vez, se terminará el contrato de trabajo con justa causa.'
                ]
            },
            {
                'subtitulo': '7. Procedimiento ante Incidentes',
                'contenido_items': [
                    'El colaborador deberá reportar el incidente al correo o canal oficial del área de TI ingenieria@mastvproducciones.net.co.',
                    'El área de TI evaluará la gravedad y emitirá un informe técnico.',
                    'La Gerencia determinará la sanción aplicable según la severidad del hecho.',
                    'Se documentará todo el proceso y se registrará en el historial de cumplimiento del empleado.'
                ]
            },
            {
                'subtitulo': '8. Aceptación',
                'contenido_items': [
                    'El colaborador declara haber leído, comprendido y aceptado las políticas y sanciones aquí descritas, comprometiéndose a su cumplimiento.'
                ]
            }
        ]
    }
    
    return render_template('politicas_seguridad.html', politicas=politicas)
